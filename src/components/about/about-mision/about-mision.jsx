				...
				<div className="about-mision__inner">
					<div className="mision-card reveal reveal--left">
						...
						<p className="mision-card__body">
							Crecer constantemente en el arte del tatuaje, con el propósito de
							brindar el mejor servicio a cada uno de nuestros clientes y
							garantizar la más alta calidad en cada trabajo que realizamos.
						</p>
					</div>
					...
					<div className="mision-card reveal reveal--right">
						...
						<p className="mision-card__body">
							Hacer renombre y consolidarnos como un referente del tatuaje,
							expandiendo nuestro alcance más allá de la ciudad hasta dejar
							huella a nivel internacional.
						</p>
