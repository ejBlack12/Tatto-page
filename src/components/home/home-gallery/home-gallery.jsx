...
const slides = [
	[
		{
			id: 1,
			src: "/images/sloth-tattoo-artwork-00.png",
			alt: "Tatuaje realista de Buda en antebrazo",
			artStyle: "Realismo",
		},
		{
			id: 2,
			src: "/images/sloth-tattoo-detail-01.png",
			alt: "Tatuaje tradicional de búho y calavera",
			artStyle: "Tradicional",
		},
		{
			id: 3,
			src: "/images/sloth-tattoo-artwork-09.png",
			alt: "Tatuaje blackwork de mariposa",
			artStyle: "Blackwork",
		},
		{
			id: 4,
			src: "/images/sloth-tattoo-detail-15.png",
			alt: "Tatuaje geométrico flor de la vida en pierna",
			artStyle: "Geometrico",
		},
	],
	[
		{
			id: 5,
			src: "/images/sloth-tattoo-artwork-12.png",
			alt: "Tatuaje minimalista de flores en espalda",
			artStyle: "Minimalista",
		},
		{
			id: 6,
			src: "/images/sloth-tattoo-artwork-07.png",
			alt: "Tatuaje realista de retrato con tocado de tigre",
			artStyle: "Realismo",
		},
		{
			id: 7,
			src: "/images/sloth-tattoo-detail-07.png",
			alt: "Tatuaje blackwork de oso y rostro nativo",
			artStyle: "Blackwork",
		},
		{
			id: 8,
			src: "/images/sloth-tattoo-artwork-08.png",
			alt: "Tatuaje acuarela de estrellas",
			artStyle: "Acuarela",
		},
	],
];
		...
		<section className="home-gallery">
			<div className="home-gallery__inner">
				<h2 className="home-gallery__title reveal">
					GALERÍA{" "}
					<span className="home-gallery__title-accent">DE TRABAJOS</span>
				</h2>
					...
					<div className="home-gallery__images">
						{slides[current].map((item, idx) => (
							...
							>
								...
								<span className="gallery-item__style-label">
									{item.artStyle}
								</span>
							</button>
						))}
				...
				<button
					type="button"
					className="home-gallery__cta reveal"
