	...
	return (
		<div className="relative overflow-hidden bg-ink-black border border-white/10 h-[260px] sm:h-[320px] lg:h-[400px]">
			...
			<div className="absolute bottom-0 left-0 right-0 px-5 pb-5 sm:px-8 sm:pb-8">
				<p className="font-inter text-[1.125rem] sm:text-[1.25rem] lg:text-[1.5rem] leading-8 text-[#f5f5f5] font-normal">
					{name}
				</p>
			</div>
		</div>
		...
		<section className="bg-ink-dark w-full py-16 sm:py-20 lg:py-32">
			<div className="max-w-[1480px] mx-auto px-5 sm:px-8 lg:px-[100px]">
				...
				<div className="mb-10 sm:mb-14 lg:mb-[60px]">
					...
					<h2 className="font-poppins font-black text-[1.75rem] sm:text-[2.25rem] lg:text-[2.8125rem] text-[#fdfdfe] uppercase tracking-[3.15px] leading-none mb-4 sm:mb-6">
						Tecnicas que dominamos
					</h2>
					<p className="font-inter text-[0.9375rem] sm:text-[1rem] lg:text-[1.125rem] leading-7 text-[#a0a0a0] max-w-[768px]">
						Cada estilo requiere técnica especializada. Nuestro equipo está
						capacitado para llevar tu visión a la realidad.
					</p>
				</div>
