...
const portfolioItems = [
	...
	{
		id: 12,
		src: "/images/sloth-tattoo-detail-09.png",
		category: "Tradicional",
	},
	{
		id: 13,
		src: "/images/sloth-tattoo-artwork-05.png",
		category: "Geometrico",
	},
	...
	{
		id: 18,
		src: "/images/sloth-tattoo-artwork-10.png",
...
const Portfolio = forwardRef(function Portfolio(
	{ initialFilter = "Todos" },
	ref,
) {
	...
	return (
		<section
			...
			ref={ref}
			className="bg-ink-black w-full py-16 sm:py-20 lg:py-32"
		>
			<div className="max-w-[1480px] mx-auto px-5 sm:px-8 lg:px-[100px]">
				{/* Section header */}
				<div className="mb-10 sm:mb-14 lg:mb-[60px]">
					<p className="font-inter text-[0.875rem] sm:text-[1rem] leading-6 text-neon-green mb-6 sm:mb-10">
						Portfolio
					</p>
					<h2 className="font-poppins font-black text-[1.75rem] sm:text-[2.25rem] lg:text-[2.8125rem] text-[#fdfdfe] uppercase tracking-[3.15px] leading-none mb-4 sm:mb-5">
						Nuestros trabajos
					</h2>
					<p className="font-inter text-[0.9375rem] sm:text-[1rem] lg:text-[1.125rem] leading-7 text-[#abb9d2]">
					...
					{FILTERS.map((filter) => {
						...
						return (
							<button
								...
								className={`px-4 py-2 sm:px-[25px] sm:py-[9px] text-[0.8125rem] sm:text-[0.875rem] font-inter leading-5 transition-colors duration-200 border ${
									isActive
