			...
			<div className="footer__inner">
				<div className="footer__brand">
					...
					<div className="footer__socials">
						<a
							href="https://www.facebook.com/p/Sloth-Ink-Tattoo-Studio-100057197209777/"
							target="_blank"
						...
						<a
							href="https://www.instagram.com/eliecer_perez2433?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
							target="_blank"
							rel="noopener noreferrer"
				...
				<div className="footer__col">
					...
					<ul className="footer__list footer__list--schedule">
						<li>
							<FaClock className="footer__list-icon" />
							<span>Lunes a sábado · 9 am – 8 pm</span>
						</li>
					</ul>
				</div>
				...
				<div className="footer__col">
					...
					<ul className="footer__list footer__list--contact">
						<li>
							...
							<span>
								En el cruce de los Chiles de Aguas Zarcas, costado norte del
								Super Todo #2
							</span>
						</li>
						<li>
							<FaEnvelope className="footer__list-icon" />
							<span>eliecerperez2433@gmail.com</span>
						</li>
						<li>
							<FaPhone className="footer__list-icon" />
							<span>+506 6157 1777 / +506 8608 4424</span>
						</li>
					</ul>
				</div>
			</div>
