...
const svgPaths = {
	// Heart / Pasión
	p261b2200:
		"M25.3333 18.6667C27.32 16.72 29.3333 14.3867 29.3333 11.3333C29.3333 9.38841 28.5607 7.52315 27.1855 6.14788C25.8102 4.77262 23.9449 4 22 4C19.6533 4 18 4.66667 16 6.66667C14 4.66667 12.3467 4 10 4C8.05508 4 6.18982 4.77262 4.81455 6.14788C3.43928 7.52315 2.66667 9.38841 2.66667 11.3333C2.66667 14.4 4.66667 16.7333 6.66667 18.6667L16 28L25.3333 18.6667Z",
	// Star / Experiencia
	p3ceb9d80:
		"M20.636 17.1867L22.656 28.5547C22.6786 28.6885 22.6598 28.8261 22.6022 28.949C22.5445 29.0719 22.4507 29.1743 22.3332 29.2424C22.2158 29.3105 22.0804 29.3412 21.9451 29.3303C21.8098 29.3194 21.681 29.2674 21.576 29.1813L16.8027 25.5987C16.5722 25.4265 16.2923 25.3335 16.0047 25.3335C15.717 25.3335 15.4371 25.4265 15.2067 25.5987L10.4253 29.18C10.3204 29.2659 10.1918 29.3178 10.0567 29.3287C9.9215 29.3396 9.78623 29.3091 9.66888 29.2412C9.55154 29.1732 9.4577 29.0711 9.39989 28.9484C9.34208 28.8258 9.32305 28.6884 9.34533 28.5547L11.364 17.1867",
	p3fb33600:
		"M16 18.6667C20.4183 18.6667 24 15.0849 24 10.6667C24 6.24839 20.4183 2.66667 16 2.66667C11.5817 2.66667 8 6.24839 8 10.6667C8 15.0849 11.5817 18.6667 16 18.6667Z",
	// People / Compromiso
	p27a3200:
		"M21.3333 28V25.3333C21.3333 23.9188 20.7714 22.5623 19.7712 21.5621C18.771 20.5619 17.4145 20 16 20H8C6.58551 20 5.22896 20.5619 4.22876 21.5621C3.22857 22.5623 2.66667 23.9188 2.66667 25.3333V28",
	p2ee517c0:
		"M12 14.6667C14.9455 14.6667 17.3333 12.2789 17.3333 9.33333C17.3333 6.38781 14.9455 4 12 4C9.05448 4 6.66667 6.38781 6.66667 9.33333C6.66667 12.2789 9.05448 14.6667 12 14.6667Z",
	p18f42980:
		"M29.3333 28V25.3333C29.3325 24.1516 28.9391 23.0037 28.2152 22.0698C27.4912 21.1358 26.4775 20.4688 25.3333 20.1733",
	p37b568c0:
		"M21.3333 4.17333C22.4806 4.46707 23.4974 5.13427 24.2235 6.06975C24.9497 7.00523 25.3438 8.15577 25.3438 9.34C25.3438 10.5242 24.9497 11.6748 24.2235 12.6103C23.4974 13.5457 22.4806 14.2129 21.3333 14.5067",
};
		...
		<section className="os-about">
			...
			>
				...
				<p className="os-about__body">
					Sloth Ink nace de la pasión por crecer en el arte del tatuaje y
					brindar el mejor servicio a cada cliente. Nuestro estudio, ubicado en
					San Carlos, Costa Rica, es un espacio donde la creatividad se fusiona
					con la técnica más refinada para garantizar la mejor calidad en cada
					trabajo.
				</p>
			</m.div>
				...
				<FeatureCard
					...
					icon={
						<svg
							fill="none"
							viewBox="0 0 32 32"
							className="os-feature-card__svg"
							role="img"
							aria-label="Pasión"
						>
							<path
								d={svgPaths.p261b2200}
								stroke="#2DD1C0"
								strokeLinecap="round"
...
function VideoPlayer({ videoSrc, posterSrc, playButtonDark = false }) {
	...
	return (
		<div className="os-video">
			{/* biome-ignore lint/a11y/useMediaCaption: video de proceso sin diálogo, no hay pista de subtítulos disponible */}
			<video
				ref={videoRef}
		...
		<LazyMotion features={domAnimation}>
			<div className="our-services-page">
				...
				<ServiceRight
					...
					imageSrc="/images/sloth-tattoo-artwork-08.png"
				...
				<ServiceLeft
					...
					features={[
						"Pigmento de alta densidad",
						"Técnica de cobertura avanzada",
						"Arte atemporal",
					]}
					imageSrc="/images/sloth-tattoo-artwork-06.png"
